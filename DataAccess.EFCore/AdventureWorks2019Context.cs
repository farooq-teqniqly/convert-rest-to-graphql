// <copyright file="AdventureWorks2019Context.cs" company="Farooq Mahmud">
...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
        {
            modelBuilder.Entity<Address>(entity =>
            {
                ...
                entity.HasIndex(
                    e => new { e.AddressLine1, e.AddressLine2, e.City, e.StateProvinceId, e.PostalCode },
            ...
            modelBuilder.Entity<BillOfMaterial>(entity =>
            {
                ...
                entity.HasIndex(
                    e => new { e.ProductAssemblyId, e.ComponentId, e.StartDate },
            ...
            modelBuilder.Entity<CurrencyRate>(entity =>
            {
                ...
                entity.HasIndex(
                    e => new { e.CurrencyRateDate, e.FromCurrencyCode, e.ToCurrencyCode },
            ...
            modelBuilder.Entity<Person>(entity =>
            {
                ...
                entity.HasIndex(
                    e => new { e.LastName, e.FirstName, e.MiddleName },
            ...
            modelBuilder.Entity<ShoppingCartItem>(entity =>
            {
                ...
                entity.HasIndex(
                    e => new { e.ShoppingCartId, e.ProductId },
            ...
            modelBuilder.Entity<StateProvince>(entity =>
            {
                ...
                entity.HasIndex(
                    e => new { e.StateProvinceCode, e.CountryRegionCode },
            ...
            modelBuilder.Entity<TransactionHistory>(entity =>
            {
                ...
                entity.HasIndex(
                    e => new { e.ReferenceOrderId, e.ReferenceOrderLineId },
