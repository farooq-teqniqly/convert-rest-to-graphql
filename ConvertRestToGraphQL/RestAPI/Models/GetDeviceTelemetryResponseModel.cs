// <copyright file="GetDeviceTelemetryResponseModel.cs" company="Farooq Mahmud">
...
namespace RestAPI.Models
{
    ...
    /// <summary>
    /// Represents an API response that contains telemetry for a specific device.
    /// </summary>
    public class GetDeviceTelemetryResponseModel
    {
        /// <summary>
